!(function(t) {
  ...
  function(t, e, n) {
    ...
    function r(t, e) {
      ...
      i(this.client.notifier),
        a(this.client.queue),
        (this.options.captureUncaught || this.options.handleUncaughtExceptions) && (f.captureUncaughtExceptions(r, this), f.wrapGlobals(r, this)),
        (this.options.captureUnhandledRejections || this.options.handleUnhandledRejections) && f.captureUnhandledRejections(r, this),
    ...
    (r.init = function(t, e) {
      ...
      (r.prototype.configure = function(t, e) {
        var n = this.options,
          r = {};
        return e && (r = { payload: e }), (this.options = c.extend({}, n, t, r)), this.client.configure(t, e), this.instrumenter.configure(t), this;
      }),
      ...
      (r.prototype.handleUnhandledRejection = function(t, e) {
        ...
        c.isError(t)
          ...
          : ((r = this._createItem([n, t, o])), (r.stackInfo = c.makeUnhandledStackInfo(n, '', 0, 0, null, 'unhandledrejection', '', b))),
  ...
  function(t, e, n) {
    ...
    (r.rateLimiter = new o(c)),
      ...
      (r.prototype.configure = function(t, e) {
        ...
        var n = this.options,
          r = {};
        return e && (r = { payload: e }), (this.options = u.extend(!0, {}, n, t, r)), this.global(this.options), this;
      }),
  ...
  function(t, e) {
    ...
    function o(t, e, n, r, o, a, s) {
      var u = null;
      return n && (n = new Error(n)), n || r || (u = i(t, e, o, a, s)), { error: n, shouldSend: r, payload: u };
    }
    function i(t, e, n, r, o) {
      ...
      return (
        'browser' === t
          ? ((s.platform = 'browser'), (s.framework = 'browser-js'), (s.notifier.name = 'rollbar-browser-js'))
          : 'server' === t
            ? ((s.framework = e.framework || 'node-js'), (s.notifier.name = e.notifier.name))
            : 'react-native' === t && ((s.framework = e.framework || 'react-native'), (s.notifier.name = e.notifier.name)),
        s
      );
    }
    (n.globalSettings = { startTime: new Date().getTime(), maxItems: void 0, itemsPerMinute: void 0 }),
    ...
    (r.prototype._maybeRetry = function(t, e, n) {
      ...
      (r.prototype._maybeLog = function(t, e) {
        if (this.logger && this.options.verbose) {
          var n = e;
          if (((n = n || o.get(t, 'body.trace.exception.message')), (n = n || o.get(t, 'body.trace_chain.0.exception.message'))))
      ...
      (r.prototype._maybeCallWait = function() {
        return (
          !(!o.isFunction(this.waitCallback) || 0 !== this.pendingItems.length || 0 !== this.pendingRequests.length) &&
  ...
  function(t, e, n) {
    ...
    function r() {
      if (
        !A &&
        ((A = !0), c(JSON) && (s(JSON.stringify) && (R.stringify = JSON.stringify), s(JSON.parse) && (R.parse = JSON.parse)), !a(R.stringify) || !a(R.parse))
      ) {
        var t = n(7);
        t(R);
      }
    ...
    function g(t) {
      ...
      for (var e = D, n = e.parser[e.strictMode ? 'strict' : 'loose'].exec(t), r = {}, i = e.key.length; i--; ) r[e.key[i]] = n[i] || '';
      return (
        (r[e.q.name] = {}),
    ...
    function y(t, e) {
      if (((e = e || t.protocol), !e && t.port && (80 === t.port ? (e = 'http:') : 443 === t.port && (e = 'https:')), (e = e || 'https:'), !t.hostname))
        return null;
      var n = e + '//' + t.hostname;
    ...
    function k(t, e, n, r, o) {
      ...
      f.length > 0 && ((u = j(!0, {}, u)), (u.extraArgs = f));
    ...
    function O(t) {
      for (var e, n = [], r = 0; r < t.length; ++r)
        (e = '\\[?(%5[bB])?' + t[r] + '\\[?(%5[bB])?\\]?(%5[dD])?'), n.push(new RegExp('(' + e + '=)([^&\\n]+)', 'igm'));
      return n;
    }
    function L(t) {
      var e,
      ...
      for (e = 0, n = t.length; e < n; e++)
        (r = t[e]),
          'object' == typeof r
            ? ((r = b(r)), (r = r.error || r.value), r.length > 500 && (r = r.substr(0, 500) + '...'))
  ...
  function(t, e) {
    ...
    t.exports = function t() {
      var e,
        ...
        f = !1;
      for (
        'boolean' == typeof c ? ((f = c), (c = arguments[1] || {}), (l = 2)) : (('object' != typeof c && 'function' != typeof c) || null == c) && (c = {});
        l < p;
        ++l
      )
        if (((e = arguments[l]), null != e))
          for (n in e)
            (r = c[n]),
              ...
              c !== a &&
                (f && a && (i(a) || (s = o(a)))
                  ? (s ? ((s = !1), (u = r && o(r) ? r : [])) : (u = r && i(r) ? r : {}), (c[n] = t(f, u, a)))
                  : 'undefined' != typeof a && (c[n] = a));
      return c;
    };
  },
  function(t, e) {
      ...
      function o(t, e) {
        ...
        switch ((h && 'object' == typeof h && 'function' == typeof h.toJSON && (h = h.toJSON(t)), 'function' == typeof c && (h = c.call(e, t, h)), typeof h)) {
          ...
          case 'object':
            ...
            else for (i in h) Object.prototype.hasOwnProperty.call(h, i) && ((u = o(i, h)), u && p.push(r(i) + (a ? ': ' : ':') + u));
            return (u = 0 === p.length ? '{}' : a ? '{\n' + a + p.join(',\n' + a) + '\n' + f + '}' : '{' + p.join(',') + '}'), (a = f), u;
        }
      }
      var i = /[\\"\u0000-\u001f\u007f-\u009f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g;
            ...
            var e,
              ...
              c = {
                ...
                '[': {
                  ...
                  ovalue: function() {
                    n.push({ container: r, state: 'ocomma', key: o }), (r = []), (e = 'firstavalue');
                  },
                  firstavalue: function() {
  ...
  function(t, e, n) {
    ...
    (r.prototype.configure = function(t) {
      ...
      var e = this.options;
      return (this.options = o.extend({}, e, t)), this;
    }),
  ...
  function(t, e, n) {
    ...
    var i = n(5),
      a = n(11),
      s = { hostname: 'api.rollbar.com', path: '/api/1/item/', search: null, version: '1', protocol: 'https:', port: 443 };
  ...
  function(t, e, n) {
    ...
    function r(t, e, n) {
      if (!s.isType(e.context, 'string')) {
        ...
        r.error ? (e.context = "Error: could not serialize 'context'") : (e.context = r.value || ''),
    ...
    function i(t, e) {
      ...
      return (
        t.search && (i += t.search),
        t.proxy && ((i = n + '//' + o + i), (o = t.proxy.host || t.proxy.hostname), (r = t.proxy.port), (n = t.proxy.protocol || n)),
    ...
    var s = n(5);
    t.exports = { buildPayload: r, getTransportFromOptions: o, transportOptions: i, appendPathToPath: a };
  },
  function(t, e, n) {
    'use strict';
    function r() {
  ...
  function(t, e) {
    ...
    function r(t, e, n, r) {
      t._rollbarWrappedError &&
        (r[4] || (r[4] = t._rollbarWrappedError), r[5] || (r[5] = t._rollbarWrappedError._rollbarContext), (t._rollbarWrappedError = null)),
    ...
    function i(t, e, n, r, o, i) {
      ...
      try {
        try {
          ...
          f.open(n, e, !0),
            f.setRequestHeader && (f.setRequestHeader('Content-Type', 'application/json'), f.setRequestHeader('X-Rollbar-Access-Token', t)),
  ...
  function(t, e) {
    ...
    function n(t) {
      var e,
        n,
        r = { protocol: null, auth: null, host: null, path: null, hash: null, href: t, hostname: null, port: null, pathname: null, search: null, query: null };
      if (
        ((e = t.indexOf('//')),
        ...
        if (((e = t.indexOf('?', n)), e === -1))
          return (
            (e = t.indexOf('#', n)),
            e === -1 ? (r.host = t.substring(n)) : ((r.host = t.substring(n, e)), (r.hash = t.substring(e))),
  ...
  function(t, e, n) {
    ...
    function a(t) {
      return function(e, n, r) {
        ...
        n.captureIp ? n.captureIp !== !0 && (o += '_anonymize') : (o = null),
          h.set(e, 'data.request', { url: t.location.href, query_string: t.location.search, user_ip: o }),
          r(null, e);
      };
    }
    function s(t) {
      return function(e, n, r) {
        ...
        h.set(e, 'data.client', {
          ...
          javascript: { browser: o.userAgent, language: o.language, cookie_enabled: o.cookieEnabled, screen: { width: i.width, height: i.height } },
        }),
          r(null, e);
      };
    }
    function u(t) {
      return function(e, n, r) {
        ...
        for (var o, i = [], a = t.navigator.plugins || [], s = 0, u = a.length; s < u; ++s) (o = a[s]), i.push({ name: o.name, description: o.description });
    ...
    function l(t, e, n) {
      ...
      var s = { body: r };
      o && (s.extra = h.extend(!0, {}, o)), h.set(t, 'data.body', { message: s }), n(null, t);
    }
    function p(t, e, n) {
        ...
        for (c.frames = [], w = 0; w < p.length; ++w)
          (f = p[w]),
            ...
            (m.method && m.method.endsWith && m.method.endsWith('_rollbar_wrapped')) ||
              ...
              b && ((_ = Math.floor(b / 2)), (v = f.context.slice(0, _)), (g = f.context[_]), (y = f.context.slice(_))),
              g && (m.code = g),
              (v || y) && ((m.context = {}), v && v.length && (m.context.pre = v), y && y.length && (m.context.post = y)),
              f.args && (m.args = f.args),
              c.frames.push(m));
        c.frames.reverse(), i && (c.extra = h.extend(!0, {}, i)), h.set(t, 'data.body', { trace: c }), n(null, t);
  ...
  function(t, e, n) {
    ...
    t.exports = { guessFunctionName: r, guessErrorClass: u, gatherContext: o, parse: s, Stack: a, Frame: i };
  },
  function(t, e, n) {
    var r, o, i;
    !(function(a, s) {
  ...
  function(t, e, n) {
    ...
    function i(t, e, n) {
      ...
      if ((o || ((r = 'data.body.trace'), (o = u.get(t, r))), o)) {
        ...
        var i = u.get(t, r + '.extra') || {},
          a = u.extend(!0, {}, i, { message: t.message });
        u.set(t, r + '.extra', a);
      }
      n(null, t);
    }
    ...
    var u = n(5);
    t.exports = { itemToPayload: r, addTelemetryData: o, addMessageWithError: i, userTransform: a, addConfigToPayload: s };
  },
  function(t, e, n) {
    'use strict';
    function r(t, e) {
  ...
  function(t, e, n) {
    ...
    var c = n(5);
    t.exports = { checkLevel: r, userCheckIgnore: o, urlIsNotBlacklisted: i, urlIsWhitelisted: a, messageIsIgnored: u };
  },
  function(t, e, n) {
    'use strict';
    function r(t, e, n, r, o) {
    ...
    function i(t, e, n, r, o) {
      ...
      t.enabled === !1 || i === !1 ? (this.autoInstrument = {}) : (a.isType(i, 'object') || (i = c), (this.autoInstrument = a.extend(!0, {}, c, i))),
    ...
    var a = n(5),
      s = n(17),
      u = n(26),
      c = { network: !0, networkResponseHeaders: !1, networkResponseBody: !1, networkRequestBody: !1, log: !0, dom: !0, navigation: !0, connectivity: !0 };
    (i.prototype.configure = function(t) {
      var e = t.autoInstrument,
        n = a.extend(!0, {}, this.autoInstrument);
      t.enabled === !1 || e === !1 ? (this.autoInstrument = {}) : (a.isType(e, 'object') || (e = c), (this.autoInstrument = a.extend(!0, {}, c, e))),
        this.instrument(n),
      ...
      (i.prototype.instrument = function(t) {
        !this.autoInstrument.network || (t && t.network)
          ...
          !this.autoInstrument.log || (t && t.log) ? !this.autoInstrument.log && t && t.log && this.deinstrumentConsole() : this.instrumentConsole(),
          !this.autoInstrument.dom || (t && t.dom) ? !this.autoInstrument.dom && t && t.dom && this.deinstrumentDom() : this.instrumentDom(),
        ...
        if ('XMLHttpRequest' in this._window) {
          ...
          r(
            ...
            function(t) {
              return function(e, n) {
                return (
                  a.isType(n, 'string') && (this.__rollbar_xhr = { method: e, url: n, status_code: null, start_time_ms: a.now(), end_time_ms: null }),
                      ...
                      if (1 === s.readyState) s.__rollbar_xhr.start_time_ms = a.now();
                        ...
                        if (e.autoInstrument.networkResponseHeaders) {
                          ...
                          try {
                            ...
                            } else for (u = 0; u < r.length; u++) (i = r[u]), (n[i] = s.getResponseHeader(i));
                          } catch (t) {}
                        }
                        var h = null;
          ...
          r(
            ...
            function(t) {
              return function(n, r) {
                ...
                var p = { method: l, url: u, status_code: null, start_time_ms: a.now(), end_time_ms: null },
                  f = null;
                return (
                  e.autoInstrument.networkRequestBody &&
                    (o[1] && o[1].body ? (f = o[1].body) : o[0] && !a.isType(o[0], 'string') && o[0].body && (f = o[0].body)),
      ...
      (i.prototype.handleClick = function(t) {
        try {
          ...
          n && (r || u.isDescribedElement(e, 'input', ['button', 'submit']))
            ...
            : u.isDescribedElement(e, 'input', ['checkbox', 'radio']) && this.captureDomEvent('input', e, e.value, e.checked);
        } catch (t) {}
      }),
            ...
            (u.isDescribedElement(e, 'textarea')
              ...
              : u.isDescribedElement(e, 'select') && e.options && e.options.length
                ...
                : u.isDescribedElement(e, 'input') &&
                  !u.isDescribedElement(e, 'input', ['button', 'submit', 'hidden', 'checkbox', 'radio']) &&
                  this.captureDomEvent('input', e, e.value));
        } catch (t) {}
      }),
      ...
      (i.prototype.deinstrumentConnectivity = function() {
        ('addEventListener' in this._window || 'body' in this._document) &&
          (this._window.addEventListener ? this.removeListeners('connectivity') : o(this.replacements, 'connectivity'));
      }),
  ...
  function(t, e) {
    ...
    function u(t) {
      ...
      for (i.attributes = [], o = 0; o < a.length; o++) (n = a[o]), (r = t.getAttribute(n)), r && i.attributes.push({ key: n, value: r });
      return i;
    }
    t.exports = {
      describeElement: u,
